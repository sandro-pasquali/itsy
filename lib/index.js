...
var tempPort = 'tcp://127.0.0.1:12345';
...
function Subscriber(topic, port) {
	...
	this.sub.connect(tempPort, function(err) {
		if(err) {
			throw new Error(err);
		}	
	});
	...
	this.fulfill = function() {
		...
		console.log("Subscribed :: ", prefix)

		this.sub.subscribe(prefix);
		this.sub.__prefix__ = prefix;
